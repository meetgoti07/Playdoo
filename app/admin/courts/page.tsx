...
import AdminCourtsList from "@/components/admin/courts/AdminCourtsList";
import { useAdminCourts } from "@/hooks/swr/courts/useAdminCourts";
...
export default function AdminCourtsPage() {
  ...
  const { data: courtsData, isLoading, mutate } = useAdminCourts({
  ...
  const pagination = courtsData?.pagination;
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage and oversee all courts across facilities</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Filter and search courts across all facilities</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <Input
                placeholder="Search courts, facilities..."
                value={searchTerm}
