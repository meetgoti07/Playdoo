...
export default function EditCourtModal({ court, isOpen, onClose, onCourtUpdated }: EditCourtModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const validatedData = updateCourtSchema.parse(changedData);
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the court details. Only changed fields will be saved.
          </DialogDescription>
        </DialogHeader>
